...
public class SecondActivity extends Activity {
    ...
    private static final String get_all = "http://192.168.0.230:3000/api/informations/get_all";
    boolean locked;
        ...
        public void handleMessage (Message msg) {
            switch (msg.what) {
                case SHOW_RESPONSE:
                    ...
                    ListView response_text = (ListView)findViewById(R.id.response_text);
                    ...
                    BaseAdapter info_listview = new BaseAdapter() {
                        ...
                        public View getView(int position, View convertView, ViewGroup parent) {
                            View view = null;
                            if (convertView == null) {
                                view = LayoutInflater.from(SecondActivity.this).inflate(R.layout.info_listview, null);
                            } else {
                                view = convertView;
                            }
                    ...
                    response_text.setAdapter(info_listview);
                    break;
                case SHOW_INFORMATION:
                    ...
                    Intent intent = new Intent(SecondActivity.this, InformationShowActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        response_text.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
